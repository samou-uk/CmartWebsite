      ...
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="hover-link text-white/80 hover:text-white transition-colors text-sm">
                  {t('nav.home')}
                </Link>
              </li>
              <li>
                <Link to="/about" className="hover-link text-white/80 hover:text-white transition-colors text-sm">
                  {t('nav.about')}
                </Link>
              </li>
              <li>
                <Link to="/recipes" className="hover-link text-white/80 hover:text-white transition-colors text-sm">
                  {t('nav.recipes')}
                </Link>
              </li>
              <li>
                <Link to="/location" className="hover-link text-white/80 hover:text-white transition-colors text-sm">
                  {t('nav.location')}
                </Link>
              </li>
              <li>
                <Link to="/contact" className="hover-link text-white/80 hover:text-white transition-colors text-sm">
                  {t('nav.contact')}
                </Link>
              </li>
              <li>
                <Link to="/games/recipe-builder" className="hover-link text-white/80 hover:text-white transition-colors text-sm">
                  {t('nav.games')}
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/60">
            ...
            <div className="flex items-center gap-4">
              <Link to="/privacy" className="hover-link hover:text-white transition-colors">
                {t('footer.privacy')}
              </Link>
              <span>•</span>
              <Link to="/terms" className="hover-link hover:text-white transition-colors">
                {t('footer.terms')}
              </Link>
            </div>
          </div>
