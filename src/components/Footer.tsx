...
export default function Footer() {
  ...
  const muted = 'text-primary-forest/85'
  const heading = 'text-primary-forest'
  const iconAccent = 'text-primary'
  const hairline = green ? 'border-primary-forest/15' : 'border-primary-forest/10'
  const bottomMuted = 'text-primary-forest/70'
  const bullet = green ? 'text-primary-forest/30' : 'text-primary-forest/30'

  return (
    <footer
      className={
        green
          ? 'bg-primary-50 text-primary-forest border-t-2 border-primary-forest/20'
